<?php
	...
	*/
	...
	/* array_push() parameter format: Format:

		1. First variable is the appropriate SQL Query.
		2. Second variable is an empty array. We will fill this later. 
	    3. Third variable is the total number of variables expressed as their appropriate type. s = string, i = integer. si = string + integer, etc.
		4. Forth variable is the regex to match this search pattern.
		5. Fifth variable is the type of search we're performing.
		6. Sixth variable is the language.
	
	
	// $query, $parameters, $parameterTypes, $regex, $queryType, $lang)
	*/
